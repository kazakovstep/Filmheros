  ...
  return (
    <>
      <div className={cn(styles.auth)}>
        ...
        <H type={"body"} className={cn(styles.text, Htag.body)}>Введите e-mail, указанный при регистрации — на него<br></br> придет письмо с ссылкой на сброс пароля</H>
